...
- vue 路由守卫函数。beforeEach afterEach
- 动态组件 Vue.extend
- vue 插槽的理解？
- 自定义指令的两个参数？
...
- Object.assign
    - Object.assign()方法用于将所有可枚举属性的值从一个或者多个源对象 source 复制到目标对象。它将返回目标对象 target。
    - 浅拷贝。
...
- [域名,跨域,防盗链](https://blog.csdn.net/u012060033/article/details/82154409)
